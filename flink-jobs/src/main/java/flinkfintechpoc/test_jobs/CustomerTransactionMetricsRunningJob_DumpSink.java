...
public class CustomerTransactionMetricsRunningJob_DumpSink {
    ...
    public static void main(String[] args) throws Exception {
        ...
        runningMetrics
                .map(CustomerTransactionMetricsRunningJob_DumpSink::toJson)
                .disableChaining()
                .print()
                .name("Customer Transaction Metrics Running Output");

        env.execute("Customer Transaction Metrics Running Job - Dump Sink");
    }
