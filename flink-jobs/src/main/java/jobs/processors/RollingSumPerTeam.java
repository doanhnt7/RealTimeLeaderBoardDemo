...
public class RollingSumPerTeam extends KeyedProcessFunction<String, UserScore, TeamTotal> {
	...
	@Override
	public void processElement(UserScore value, Context ctx, Collector<TeamTotal> out) throws Exception {
