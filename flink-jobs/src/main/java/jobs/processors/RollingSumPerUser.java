...
public class RollingSumPerUser extends KeyedProcessFunction<String, User, PlayerTotal> {
	...
	@Override
	public void processElement(User value, Context ctx, Collector<PlayerTotal> out) throws Exception {
